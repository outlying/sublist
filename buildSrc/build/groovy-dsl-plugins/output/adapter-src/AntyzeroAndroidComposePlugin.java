...
/**
 * Precompiled antyzero.android.compose script plugin.
 **/
public class AntyzeroAndroidComposePlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_AntyzeroAndroidCompose").asSubclass(BasicScript.class);
