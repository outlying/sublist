...
/**
 * Precompiled antyzero.jvm.base script plugin.
 **/
public class AntyzeroJvmBasePlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_AntyzeroJvmBase").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("antyzero.base");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_AntyzeroJvmBase").asSubclass(BasicScript.class);
