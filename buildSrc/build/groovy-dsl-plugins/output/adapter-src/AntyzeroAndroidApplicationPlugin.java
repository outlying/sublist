...
/**
 * Precompiled antyzero.android.application script plugin.
 **/
public class AntyzeroAndroidApplicationPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_AntyzeroAndroidApplication").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("antyzero.android.base");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_AntyzeroAndroidApplication").asSubclass(BasicScript.class);
