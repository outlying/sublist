...
/**
 * Precompiled antyzero.base script plugin.
 **/
public class AntyzeroBasePlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_AntyzeroBase").asSubclass(BasicScript.class);
