...
/**
 * Precompiled antyzero.android.base script plugin.
 **/
public class AntyzeroAndroidBasePlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_AntyzeroAndroidBase").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("com.android.base");
            target.getPluginManager().apply("org.jetbrains.kotlin.android");
            target.getPluginManager().apply("antyzero.jvm.base");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_AntyzeroAndroidBase").asSubclass(BasicScript.class);
